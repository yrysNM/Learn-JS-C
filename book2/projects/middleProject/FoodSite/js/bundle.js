...
function cards() {
  ...
  class MenuCard {
    constructor(src, alt, title, descer, price, parentSelector) {
      this.src = src;
      this.alt = alt;
      this.title = title;
      this.descer = descer;
...
function forms(formSelector, modalTimerId) {
  ...
  function bindpostData(form) {
    form.addEventListener("submit", e => {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_1__["default"])("http://localhost:3000/requests", json).then(data => {
        console.log(data);
...
(__webpack_require__(/*! es6-promise */ "./node_modules/es6-promise/dist/es6-promise.js").polyfill)(); //polyfill 9.5
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])(".timer", "2022-12-31");
