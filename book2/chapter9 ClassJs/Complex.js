...
class Complex {
	// One class field declarations are standardized we = could declare
	// private  fileds to hold the real and imaginary parts of  a complex number
	...
	constructor(real, imaginary){
		this.r= real; 				// This filed holds the real part of the number;
		this.i = imaginary;			// This filed hilds the imaginary part.
	}

	// Here are  two instance methods for addition and multiplicaiton
...
let d = new Complex(c.i, c.r);		// use instance fileds of c
console.log(c.plus(d).toString());  // => {5,5}; use instance methods
console.log(c.magnitude);			// => Math.hypot(2, 3) ise a getter method
